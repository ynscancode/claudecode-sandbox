...
export const THEMES = {
  refined: {
    ...
    '--topup': '#4FB3A7', '--green': '#6BBF73', '--red': '#D98167', '--warning': '#FFE14D',
  ...
  editorial: {
    ...
    '--topup': '#3F8C7F', '--green': '#3F8C7F', '--red': '#B6542F', '--warning': '#D9A40C',
  ...
  terminal: {
    ...
    '--topup': '#5BC8C0', '--green': '#6FCF73', '--red': '#E47B6D', '--warning': '#FAF066',
